...
<%@ page import="mg.working.cryptomonnaie.model.analyse.AnalyseCommission" %>
<!DOCTYPE html>
<html lang="en">
...
<%
    ...
    List<AnalyseCommission> analyseCommissions = (List<AnalyseCommission>) request.getAttribute("analyseCommissions");
%>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="analyseCommissionFiltre" method="post">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table" id="cryptoTable">
                            ...
                            <tbody>
                            <% for (AnalyseCommission analyseCommission : analyseCommissions) { %>
                            <tr>
                                <th><%= analyseCommission.getCryptoMonnaie().getSymbol() %></th>
                                <td><%= analyseCommission.getSomme() %></td>
                                <td><%= analyseCommission.getMoyenne() %></td>
                            </tr>
                            <% } %>
                            </tbody>
                        </table>
