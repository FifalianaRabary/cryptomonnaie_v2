                    ...
                    <div class="card-body">
                        ...
                        <form action="updateProfile" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="mail" name="mail" value="<%= utilisateur.getMail() %>">
                            </div>

                            <div class="mb-3">
                                <label for="mdp" class="form-label">Password :</label>
                                <input type="text" class="form-control" id="mdp" name="mdp" value="aaa">
                            </div>

                            <div class="mb-3">
                                <label for="dtn" class="form-label">Date de Naissance :</label>
                                <input type="date" class="form-control" id="dtn" name="dtn" value="<%= utilisateur.getDtn() %>">
                            </div>
